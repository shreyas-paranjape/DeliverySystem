package in.co.foodamigo.foodapp.module.drawer.domain;
...
import in.co.foodamigo.foodapp.module.drawer.domain.Item;
import in.co.foodamigo.foodapp.module.drawer.domain.ItemGroup;
...
public class DrawerController {
    ...
    private void prepareListData() {
        ...
        terms.getItems().add(new Item("Like this app") {
            @Override
            public Fragment getDisplayFragment() {
                return null;
            }
